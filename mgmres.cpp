...
//    Input, long int NZ_NUM, the number of nonzeros.
//
//    Input, long int IA[NZ_NUM], JA[NZ_NUM], the row and column indices
...
void ax_st ( long int n, long int nz_num, long int ia[], long int ja[], double a[], double x[],
  double w[] )
...
//  Parameters:
//
//    Input, long int N, the number of entries in the vector.
//
//    Input/output, long int *SEED, a seed for the random number generator.
//
